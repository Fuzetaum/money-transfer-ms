...
public class TransferAttemptDao extends DAOImpl<TransferAttemptRecord, com.revolut.test.backend.ricardofuzeto.database.tables.pojos.TransferAttempt, String> {
    ...
    @Override
    public String getId(com.revolut.test.backend.ricardofuzeto.database.tables.pojos.TransferAttempt object) {
        return object.getId();
    }
     ...
     */
    public List<com.revolut.test.backend.ricardofuzeto.database.tables.pojos.TransferAttempt> fetchRangeOfId(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.revolut.test.backend.ricardofuzeto.database.tables.pojos.TransferAttempt> fetchById(String... values) {
     ...
     */
    public com.revolut.test.backend.ricardofuzeto.database.tables.pojos.TransferAttempt fetchOneById(String value) {
